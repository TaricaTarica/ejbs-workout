...
a persistence unit "pco1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pco1\pom.xml":
...
artifacts ("pco1-ejb.jar" and "pco1-web.war") are already built. You can build
